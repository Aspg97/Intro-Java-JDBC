...
public final class UsuarioDAO extends DAO {
	...
	public void guardarUsuario(Usuario usuario) throws Exception {
		try {
			...
			String sql = "INSERT INTO Usuario(correoElectronico, clave) VALUES ('" + usuario.getCorreoElectronico()
					+ "','" + usuario.getClave() + "')";
	...
	public Usuario buscarUsuario(String correoElectronico) throws Exception {
		try {
